...
/**
 * This class is used to implement the downloading of files from the given
 * website
 *
 * @author Nacer Abreu
...
public class DownloadImageTask implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(DownloadImageTask.class.getName()).log(Level.SEVERE, null, ex);
        }

    }

    /**
     * This method will take a filename and return the size of the file in
     * kilobytes
     *
